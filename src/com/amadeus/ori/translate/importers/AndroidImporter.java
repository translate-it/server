...
public class AndroidImporter implements Importer {
	...
	private List<TranslationImportDTO> parseResources(XMLStreamReader reader) throws Exception {
	...
	private TranslationImportDTO parseString(XMLStreamReader reader) throws Exception {
		...
		if (item.hasKey()) {
			...
			throw new Exception("Invalid format: key=\"" + key + "\", value=\"" + translation + "\"");
		}
